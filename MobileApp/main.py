...
class SignIn(Screen):
    def check_account(self):
        ...
        cmd = 'select email, pass from user'
...
class SignUp(Screen):
    def create_account(self):
        ...
        cmd = 'insert into user (name, surname, gender, dateBirth, email, pass) values (%s, %s, %s, %s, %s, %s)'
...
class MessApp(MDApp):
    def build(self):
        ...
        self.sc.add_widget(Settings(name='settigns'))
        return self.sc
